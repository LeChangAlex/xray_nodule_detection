...
for k=1:length(files)
    ...
    if xraynum % nodule xrays
        %imagename = strcat('chestXRays', int2str(CTnum), '/Xray', int2str(xraynum), '_', int2str(nodulePosition(1)), '_', int2str(nodulePosition(2)), '_', int2str(nodulePosition(3)), '_', int2str(noduleDimension(1)), '_', int2str(noduleDimension(2)), '_', int2str(noduleDimension(3)), '_', strrep(num2str(noduleSize),'.','-'), '_', int2str(noduleHU));
